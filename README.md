...
# 1. Problem Understanding (Context & Scope)
...
# 2. Research Skill (Domain Knowledge Integration)
...
# 3. Effective Problem Solving (Technical Workflow)
...
# 4. Good Logical Explanation (Synthesis & Interpretation)
